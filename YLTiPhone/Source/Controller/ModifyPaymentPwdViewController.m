...
- (void)viewDidLoad
{
    ...
    self.originalPwdTF = [[PwdLeftTextField alloc] initWithFrame:CGRectMake(10, 100+ios7_h, 300, 44) left:@"" prompt:@"请输入原支付密码"];
    [self.view addSubview:self.originalPwdTF];
    
    self.freshPwdTF = [[PwdLeftTextField alloc] initWithFrame:CGRectMake(10, 160+ios7_h, 300, 44) left:@"" prompt:@"请输入6位支付密码"];
    [self.view addSubview:self.freshPwdTF];
    
    self.confirmPwdTF = [[PwdLeftTextField alloc] initWithFrame:CGRectMake(10, 220+ios7_h, 300, 44) left:@"" prompt:@"请再次输入支付密码"];
