//
//  FindoutPaymentPwdViewController.m
//  YLTiPhone
//
...
@interface FindoutPaymentPwdViewController ()

@end

@implementation FindoutPaymentPwdViewController
...
- (void)viewDidLoad
{
    ...
    UILabel *userInfoLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 134, 200, 40)];
